---
title: "21954100_Assessment1_PredictiveAnalytics"
output: html_notebook
---
#Libary to be used and read file 
```{r}
library(psych)
library(corrplot)
library(dplyr)
...
save.image(file = 'Assessment1')
load(file = 'Assessment1')
```
#PART_B
##Question 1: Perform the transformation
```{r}
...
##Question 5a: Dimension Reduction
```{r}
...
##Question 5c: Input variables distribution against SalePrice
```{r}
